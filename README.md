...
eval_llm_962.csv:  This file contains qualitative evaluation outputs generated by the OpenAI API for each lecture in the VT-SSum dataset. Each row corresponds to a single lecture file, along with the evaluator's scoring and justification.
